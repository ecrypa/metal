...
IS_SAME(metal::v4::min_element<nums, comp_lt>, metal::number<-7>);

using comp_gt = metal::lambda<metal::greater>;
IS_SAME(metal::v4::min_element<nums, comp_gt>, metal::number<42>);
...
static_assert(
  !metal::is_invocable<
  metal::lambda<metal::v4::min_element>,
  nums,
...
using smaller = metal::number<(sizeof(x) < sizeof(y))>;
IS_SAME(metal::v4::min_element<vals, metal::lambda<smaller>>, char[1]);

template<typename x, typename y>
using larger = metal::number<(sizeof(x) > sizeof(y))>;
IS_SAME(metal::v4::min_element<vals, metal::lambda<larger>>, const char[3]);
/// [v4::min_element]
)
...
using comp_lt = metal::lambda<metal::less>;
IS_SAME(metal::v5::min_element<nums, comp_lt>, metal::number<-7>);

using comp_gt = metal::lambda<metal::greater>;
IS_SAME(metal::v5::min_element<nums, comp_gt>, metal::number<42>);
...
static_assert(
  !metal::is_invocable<
  metal::lambda<metal::v5::min_element>,
  nums,
  metal::lambda<bad_comp_three_args>
  >{}, "");
...
template<typename x, typename y>
using smaller = metal::number<(sizeof(x) < sizeof(y))>;
IS_SAME(metal::v5::min_element<vals, metal::lambda<smaller>>, char[1]);

template<typename x, typename y>
using larger = metal::number<(sizeof(x) > sizeof(y))>;
IS_SAME(metal::v5::min_element<vals, metal::lambda<larger>>, const char[3]);
/// [v5::min_element]
)
...
using comp_lt = metal::lambda<metal::less>;
IS_SAME(metal::v6::min_element<nums, comp_lt>, metal::number<-7>);

using comp_gt = metal::lambda<metal::greater>;
IS_SAME(metal::v6::min_element<nums, comp_gt>, metal::number<42>);
...
static_assert(
  !metal::is_invocable<
  metal::lambda<metal::v6::min_element>,
  nums,
  metal::lambda<bad_comp_three_args>
  >{}, "");
...
template<typename x, typename y>
using smaller = metal::number<(sizeof(x) < sizeof(y))>;
IS_SAME(metal::v6::min_element<vals, metal::lambda<smaller>>, char[1]);

template<typename x, typename y>
using larger = metal::number<(sizeof(x) > sizeof(y))>;
IS_SAME(metal::v6::min_element<vals, metal::lambda<larger>>, const char[3]);
/// [v6::min_element]
)
...
using comp_lt = metal::lambda<metal::less>;
IS_SAME(metal::v7::min_element<nums, comp_lt>, metal::number<-7>);

using comp_gt = metal::lambda<metal::greater>;
IS_SAME(metal::v7::min_element<nums, comp_gt>, metal::number<42>);
...
static_assert(
  !metal::is_invocable<
  metal::lambda<metal::v7::min_element>,
  nums,
  metal::lambda<bad_comp_three_args>
  >{}, "");
...
template<typename x, typename y>
using smaller = metal::number<(sizeof(x) < sizeof(y))>;
IS_SAME(metal::v7::min_element<vals, metal::lambda<smaller>>, char[1]);

template<typename x, typename y>
using larger = metal::number<(sizeof(x) > sizeof(y))>;
IS_SAME(metal::v7::min_element<vals, metal::lambda<larger>>, const char[3]);
/// [v7::min_element]
)
...
using comp_lt = metal::lambda<metal::less>;
IS_SAME(metal::v8::min_element<nums, comp_lt>, metal::number<-7>);

using comp_gt = metal::lambda<metal::greater>;
IS_SAME(metal::v8::min_element<nums, comp_gt>, metal::number<42>);
...
static_assert(
  !metal::is_invocable<
  metal::lambda<metal::v8::min_element>,
  nums,
  metal::lambda<bad_comp_three_args>
  >{}, "");
...
template<typename x, typename y>
using smaller = metal::number<(sizeof(x) < sizeof(y))>;
IS_SAME(metal::v8::min_element<vals, metal::lambda<smaller>>, char[1]);

template<typename x, typename y>
using larger = metal::number<(sizeof(x) > sizeof(y))>;
IS_SAME(metal::v8::min_element<vals, metal::lambda<larger>>, const char[3]);
/// [v8::min_element]
)
...
using comp_lt = metal::lambda<metal::less>;
IS_SAME(metal::v9::min_element<nums, comp_lt>, metal::number<-7>);

using comp_gt = metal::lambda<metal::greater>;
IS_SAME(metal::v9::min_element<nums, comp_gt>, metal::number<42>);
...
static_assert(
  !metal::is_invocable<
  metal::lambda<metal::v9::min_element>,
  nums,
  metal::lambda<bad_comp_three_args>
  >{}, "");
...
template<typename x, typename y>
using smaller = metal::number<(sizeof(x) < sizeof(y))>;
IS_SAME(metal::v9::min_element<vals, metal::lambda<smaller>>, char[1]);

template<typename x, typename y>
using larger = metal::number<(sizeof(x) > sizeof(y))>;
IS_SAME(metal::v9::min_element<vals, metal::lambda<larger>>, const char[3]);
/// [v9::min_element]
)
...
using comp_lt = metal::lambda<metal::less>;
IS_SAME(metal::v10::min_element<nums, comp_lt>, metal::number<-7>);

using comp_gt = metal::lambda<metal::greater>;
IS_SAME(metal::v10::min_element<nums, comp_gt>, metal::number<42>);
...
static_assert(
  !metal::is_invocable<
  metal::lambda<metal::v10::min_element>,
  nums,
  metal::lambda<bad_comp_three_args>
  >{}, "");
...
template<typename x, typename y>
using smaller = metal::number<(sizeof(x) < sizeof(y))>;
IS_SAME(metal::v10::min_element<vals, metal::lambda<smaller>>, char[1]);

template<typename x, typename y>
using larger = metal::number<(sizeof(x) > sizeof(y))>;
IS_SAME(metal::v10::min_element<vals, metal::lambda<larger>>, const char[3]);
/// [v10::min_element]
)
...
using comp_lt = metal::lambda<metal::less>;
IS_SAME(metal::v16::min_element<nums, comp_lt>, metal::number<3>);

IS_SAME(metal::v16::min_element<metal::list<>, comp_lt>, metal::number<0>);

using comp_gt = metal::lambda<metal::greater>;
IS_SAME(metal::v16::min_element<nums, comp_gt>, metal::number<1>);
...
static_assert(
  !metal::is_invocable<
  metal::lambda<metal::v16::min_element>,
  nums,
  metal::lambda<bad_comp_three_args>
  >{}, "");
...
template<typename x, typename y>
using smaller = metal::number<(sizeof(x) < sizeof(y))>;
IS_SAME(metal::v16::min_element<vals, metal::lambda<smaller>>, metal::number<1>);

template<typename x, typename y>
using larger = metal::number<(sizeof(x) > sizeof(y))>;
IS_SAME(metal::v16::min_element<vals, metal::lambda<larger>>, metal::number<0>);
/// [v16::min_element]
)
...
using comp_lt = metal::lambda<metal::less>;
IS_SAME(metal::v17::min_element<nums, comp_lt>, metal::number<3>);

IS_SAME(metal::v17::min_element<metal::list<>, comp_lt>, metal::number<0>);

using comp_gt = metal::lambda<metal::greater>;
IS_SAME(metal::v17::min_element<nums, comp_gt>, metal::number<1>);
...
static_assert(
  !metal::is_invocable<
  metal::lambda<metal::v17::min_element>,
  nums,
  metal::lambda<bad_comp_three_args>
  >{}, "");
...
template<typename x, typename y>
using smaller = metal::number<(sizeof(x) < sizeof(y))>;
IS_SAME(metal::v17::min_element<vals, metal::lambda<smaller>>, metal::number<1>);

template<typename x, typename y>
using larger = metal::number<(sizeof(x) > sizeof(y))>;
IS_SAME(metal::v17::min_element<vals, metal::lambda<larger>>, metal::number<0>);
/// [v17::min_element]
)
...
using comp_lt = metal::lambda<metal::less>;
IS_SAME(metal::v18::min_element<nums, comp_lt>, metal::number<3>);

IS_SAME(metal::v18::min_element<metal::list<>, comp_lt>, metal::number<0>);

using comp_gt = metal::lambda<metal::greater>;
IS_SAME(metal::v18::min_element<nums, comp_gt>, metal::number<1>);
...
static_assert(
  !metal::is_invocable<
  metal::lambda<metal::v18::min_element>,
  nums,
  metal::lambda<bad_comp_three_args>
  >{}, "");
...
template<typename x, typename y>
using smaller = metal::number<(sizeof(x) < sizeof(y))>;
IS_SAME(metal::v18::min_element<vals, metal::lambda<smaller>>, metal::number<1>);

template<typename x, typename y>
using larger = metal::number<(sizeof(x) > sizeof(y))>;
IS_SAME(metal::v18::min_element<vals, metal::lambda<larger>>, metal::number<0>);
/// [v18::min_element]
)
...
using comp_lt = metal::lambda<metal::less>;
IS_SAME(metal::v19::min_element<nums, comp_lt>, metal::number<3>);

IS_SAME(metal::v19::min_element<metal::list<>, comp_lt>, metal::number<0>);

using comp_gt = metal::lambda<metal::greater>;
IS_SAME(metal::v19::min_element<nums, comp_gt>, metal::number<1>);
...
static_assert(
  !metal::is_invocable<
  metal::lambda<metal::v19::min_element>,
  nums,
  metal::lambda<bad_comp_three_args>
  >{}, "");
...
template<typename x, typename y>
using smaller = metal::number<(sizeof(x) < sizeof(y))>;
IS_SAME(metal::v19::min_element<vals, metal::lambda<smaller>>, metal::number<1>);

template<typename x, typename y>
using larger = metal::number<(sizeof(x) > sizeof(y))>;
IS_SAME(metal::v19::min_element<vals, metal::lambda<larger>>, metal::number<0>);
/// [v19::min_element]
)
