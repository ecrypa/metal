...
/// [nth_element]
  ...
  static_assert(
    !metal::is_invocable<
    metal::lambda<metal::nth_element_val_randpivot::nth_element>,
  ...
  IS_SAME(
    metal::nth_element_val_randpivot::nth_element<
      metal::numbers<7, -2, 4, 1, 9>,
      metal::number<0>,
...
/// [nth_element]
  ...
  static_assert(
    !metal::is_invocable<
    metal::lambda<metal::nth_element_val_frontpivot::nth_element>,
    metal::numbers<7, -2, 4, 1, 9>,
    metal::number<0>,
    metal::lambda<cmp>
    >{},
  ...
  IS_SAME(
    metal::nth_element_val_frontpivot::nth_element<
      metal::numbers<7, -2, 4, 1, 9>,
      metal::number<0>,
      metal::lambda<metal::less>
    >,
...
/// [nth_element]
  ...
  static_assert(
    !metal::is_invocable<
    metal::lambda<metal::nth_element_val_backpivot::nth_element>,
    metal::numbers<7, -2, 4, 1, 9>,
    metal::number<0>,
    metal::lambda<cmp>
    >{},
  ...
  IS_SAME(
    metal::nth_element_val_backpivot::nth_element<
      metal::numbers<7, -2, 4, 1, 9>,
      metal::number<0>,
      metal::lambda<metal::less>
    >,
...
/// [nth_element]
  ...
  static_assert(
    !metal::is_invocable<
    metal::lambda<metal::nth_element_list_backpivot::nth_element>,
    metal::numbers<7, -2, 4, 1, 9>,
    metal::number<0>,
    metal::lambda<cmp>
    >{},
  ...
  IS_SAME(
    metal::nth_element_list_backpivot::nth_element<
      metal::numbers<7, -2, 4, 1, 9>,
      metal::number<0>,
      metal::lambda<metal::less>
    >,
    metal::numbers<-2, 1, 7, 4, 9>
  );
...
/// [nth_element]
  ...
  static_assert(
    !metal::is_invocable<
    metal::lambda<metal::nth_element_list_frontpivot::nth_element>,
    metal::numbers<7, -2, 4, 1, 9>,
    metal::number<0>,
    metal::lambda<cmp>
    >{},
  ...
  IS_SAME(
    metal::nth_element_list_frontpivot::nth_element<
      metal::numbers<7, -2, 4, 1, 9>,
      metal::number<0>,
      metal::lambda<metal::less>
    >,
    metal::numbers<-2, 4, 1, 7, 9>
  );
...
/// [nth_element]
  ...
  static_assert(
    !metal::is_invocable<
    metal::lambda<metal::nth_element_list_randpivot::nth_element>,
    metal::numbers<7, -2, 4, 1, 9>,
    metal::number<0>,
    metal::lambda<cmp>
    >{},
  ...
  IS_SAME(
    metal::nth_element_list_randpivot::nth_element<
      metal::numbers<7, -2, 4, 1, 9>,
      metal::number<0>,
      metal::lambda<metal::less>
    >,
    metal::numbers<-2, 7, 4, 1, 9>
  );
