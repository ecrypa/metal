#ifndef METAL_LIST_NTH_ELEMENT_VAL_FRONTPIVOT_HPP
#define METAL_LIST_NTH_ELEMENT_VAL_FRONTPIVOT_HPP
...
namespace metal {
namespace nth_element_val_frontpivot {
    namespace detail {
        template<typename seq>
        using _quickselect_pivot = front<seq>;
