#ifndef METAL_LIST_NTH_ELEMENT_VAL_COMPLICATED_HPP
#define METAL_LIST_NTH_ELEMENT_VAL_COMPLICATED_HPP
...
namespace nth_element_val_complicated {
    namespace detail {
        ...
        struct _make_loeq_partition<list<vals...>, piv> {
            ...
            using type = join<if_<comp<piv, vals>, list<>, list<vals>>...>;
        };
        ...
        struct _make_lo_partition<list<vals...>, piv> {
            template<template<class...> class comp>
            using type = join<if_<comp<vals, piv>, list<vals>, list<>>...>;
        };

        template<
            class prev_left, class num, class prev_piv = void,
            class prev_right = list<>, class left_loeq = prev_left,
            class right_lo = list<>,
        ...
        template<
            class prev_left, class num, class prev_piv, class prev_right,
            class left_loeq, class right_lo>
        struct _quickselect<
            prev_left, num, prev_piv, prev_right, left_loeq, right_lo, true_,
            false_> {
            ...
            using type = ::metal::detail::forward<
                _quickselect<
                    ...
                    ::metal::detail::forward<
                        _make_loeq_partition<left, piv>::template type, comp>,
                    ::metal::detail::forward<
                        _make_lo_partition<right, piv>::template type,
                        comp>>::template type,
                comp>;
        };
        ...
        template<
            ...
            class left_loeq, class right_lo>
        struct _quickselect<
            prev_left, num, prev_piv, prev_right, left_loeq, right_lo, false_,
            true_> {
            template<template<class...> class comp>
            using type = prev_piv;
        };
        ...
        struct _quickselect<
            ...
            using next_num =
                sub<num, add<size<left_loeq>, size<right_lo>>, number<1>>;

            template<template<class...> class comp>
            using type = ::metal::detail::forward<
                _quickselect<
                    left, next_num, piv, right,
                    ::metal::detail::forward<
                        _make_loeq_partition<left, piv>::template type, comp>,
                    ::metal::detail::forward<
                        _make_lo_partition<right, piv>::template type,
        ...
        struct _nth_element_impl<
            ...
            template<template<class...> class comp>
            using type = ::metal::detail::forward<
                _quickselect<list<vals...>, num>::template type, comp>;
        };
